  ...
  return (
    <>
      ...
      <section className="w-full py-10 lg:py-14">
        <Container className="flex flex-col gap-6 max-w-3xl mx-auto !px-0">
  ...
  return (
    <section className="w-full py-8">
      <Container className="max-w-3xl mx-auto !px-0">
        <div className="flex justify-center border-y-2 border-[#00b67a] py-5 w-full">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-0 border border-gray-200 pl-0 pr-4 py-2">
