          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div className="bg-[var(--color-light)] rounded-xl px-5 py-4 flex flex-col md:flex-row md:items-center gap-3 w-full lg:w-fit lg:mx-auto">
              ...
              <input
                ...
                maxLength={5}
                className="h-11 flex-1 bg-white rounded-lg px-4 text-sm text-[#131212] placeholder:text-gray-400 border-0 shadow-none focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)] w-full min-w-0"
              />
