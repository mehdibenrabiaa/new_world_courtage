...
export default function ArticleSection({ title, children, titleFont = "sans" }) {
  return (
    <section className="flex flex-col gap-4">
      <h2 className={`text-[17px] sm:text-xl font-bold text-[#131212] ${titleFont === "serif" ? libreCaslon.className : ""}`}>{title}</h2>
