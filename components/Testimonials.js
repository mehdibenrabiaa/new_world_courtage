        ...
        <div className="rounded-[20px] overflow-hidden flex flex-col lg:flex-row min-h-[480px] bg-[var(--color-jungle-green)]">
          ...
          <div className="lg:w-2/3 px-8 py-10 lg:px-14 lg:py-14 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-5">
              {/* Heading */}
              <h2
                className={`text-[8vw] sm:text-[42px] lg:text-[55px] leading-[1.1] text-white ${libreCaslon.className}`}
              >
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 mt-5">
              {STATS.map(({ number, label }) => (
                <div key={label}>
                  <p className={`text-[44px] lg:text-[72px] leading-none text-white ${libreCaslon.className}`}>
                    {number}
                  </p>
                  <p className="text-[13px] lg:text-[16px] text-white mt-2">{label}</p>
                </div>
              ))}
            </div>
